...
#    df_scatter = (spacex_df['Payload Mass (kg)'] > low) & (spacex_df['Payload Mass (kg)'] < high)
    ...
    if site_dropdown == 'ALL':
        scatter_fig = px.scatter(df_scatter, x="Payload Mass (kg)", y="class", color="Booster Version Category", title='Payload Susccess Rate for All Site' )
        return scatter_fig

    else:
        filtered_scatter = df_scatter[df_scatter['Launch Site'] == site_dropdown]
        scatter_fig = px.scatter(filtered_scatter, x="Payload Mass (kg)", y="class", color="Booster Version Category", title='Payload Susccess Rate for {site_dropdown}')
        return scatter_fig        
